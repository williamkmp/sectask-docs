# Sequence Diagram: Delete Project Report
...
```mermaid
    ...
    sequenceDiagram
        ...
        Writer->>UI: clicks delete project report button
        activate UI
        UI->>ProjectController: POST project/:projectId/report/remove/:fileId
        ...
        deactivate EventGateway
        UI->>Viewer: remove report entry to project's file display tab
